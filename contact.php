...
<body>
    ...
    <div class="container-fluid" id="about-home">
        ...
        <div class="row">
            <div class="col-md-12 about-home-text" >
                <h1><b>Contact</b></h1>
                <p class="text-center">If you would like to donate to our cause or report a stray animal, <br>then please contact our 24/7 help center</p>
            </div>
        </div>
    </div>
    </section>
    ...
    <section id="team">
        <div class="container-fluid text-center">
            <h1 class="h1-team"><b>Contact Information Center</b></h1>
            <p class="p-team">For any inquiries or assistance, please contact us via email, phone, or in person using the information provided below.</p>
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-title">
                            <img src="src/contact-contact-gmail.png" alt="" class="img-fluid donate-account">
                        </div>
                        <div class="card-body">
                            <h1>Petpev@gmail.com</h1>
                            <p>ACCOUNT</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                        <div class="card-title">
                            <img src="src/contact-contact-phone.png" alt="" class="img-fluid donate-account" >
                        </div>
                        <div class="card-body">
                            <h1>+(091 2345 678)</h1>
                            <p>NUMBER</p>
                ...
                <div class="card">
                        <div class="card-title">
                            <img src="src/contact-contact-location.png" alt="" class="img-fluid donate-account">
                        </div>
                        <div class="card-body">
                            <h1>Villa Victorias, Victorias City Negros Occidental Philippines</h1>
                            <p>LOCATION</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="container" >
                    <div class="row"> 
                        ...
                        <div class="col-md-8 text-center overflow-text">
                            ...
                            <input class="input-overflow" type="text" placeholder="Your Email address" style="border:grey solid 1px;height:40px;width:15rem;padding:0 0 0 10px">
